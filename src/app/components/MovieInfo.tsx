...
import { ChevronDownIcon, PlayIcon, PlusIcon } from 'lucide-react';
import { SpeakerWaveIcon, UserGroupIcon } from '@heroicons/react/16/solid';
import { Movie } from '../types/movies';
import { MovieRating } from './MovieRating';


export function MovieInfo(movie: Movie) {
    return <div className="absolute z-10 w-full rounded-b-md bg-zinc-800 p-2 shadow-md transition lg:p-4">
